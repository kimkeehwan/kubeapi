...
func (s *MetricImpl) ListNode(ctx context.Context, selector string) (*metricsV1beta1api.NodeMetricsList, error) {
...
func (s *MetricImpl) GetNode(ctx context.Context, name string) (*metricsV1beta1api.NodeMetrics, error) {
	opt := metav1.GetOptions{}

	return s.clients.MetricsV1beta1().NodeMetricses().Get(ctx, name, opt)
}

func (s *MetricImpl) ListPod(ctx context.Context, namespace string, selector string) (*metricsV1beta1api.PodMetricsList, error) {
	opts := metav1.ListOptions{}
	if selector != "" {
		opts.LabelSelector = selector
	}
...
func (s *MetricImpl) GetPod(ctx context.Context, namespace string, name string) (*metricsV1beta1api.PodMetrics, error) {
	opt := metav1.GetOptions{}
